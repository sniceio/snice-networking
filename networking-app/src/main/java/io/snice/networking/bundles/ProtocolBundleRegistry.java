...
public interface ProtocolBundleRegistry {
    ...
    <K extends Connection<T>, T, C extends NetworkAppConfig> void registerBundle(final ProtocolBundle<K, T, C> bundle, final Class klass);

    <K extends Connection<T>, T, C extends NetworkAppConfig> void registerBundle(final ProtocolBundle<K, T, C> bundle, final Class klass, final String scheme);
     ...
     */
    <K extends Connection<T>, T, C extends NetworkAppConfig> Optional<ProtocolBundle<K, T, C>> find(Class<T> type);
