...
public class ConnectionCtxBuilder<K extends Connection<T>, T, R> implements ConnectionContext.Builder<K, T, R> {
    ...
    private class ConfBuilder implements ConnectionContext.ConfigurationBuilder<K, T, R> {
        ...
        @Override
        public ConnectionContext.MessageProcessingBuilder<K, T, R> match(final Predicate<T> filter) {
    ...
    private class MessageProcessingBuilderImpl<K extends Connection<T>, T, R> implements ConnectionContext.MessageProcessingBuilder<K, T, R> {
        ...
        @Override
        public <NEW_R> ConnectionContext.MessageProcessingBuilder<K, T, NEW_R> withPipe(final MessagePipe<K, ? super R, ? extends NEW_R> f) {
            return null;
        }

        @Override
        public ConnectionContext.MessageProcessingBuilder<K, T, R> consume(final Consumer<R> consumer) {
        ...
        @Override
        public ConnectionContext.MessageProcessingBuilder<K, T, R> consume(final BiConsumer<K, R> consumer) {
            final var builder = new MessageProcessingBuilderImpl(pipe.consume(consumer));
            child = builder;
            return builder;
        }
        ...
        @Override
        public <NEW_R> ConnectionContext.MessageProcessingBuilder<K, T, NEW_R> map(final Function<? super R, ? extends NEW_R> f) {
        ...
        @Override
        public <NEW_R> ConnectionContext.MessageProcessingBuilder<K, T, NEW_R> map(final BiFunction<K, ? super R, ? extends NEW_R> f) {
            final var builder = new MessageProcessingBuilderImpl(pipe.map(f));
            child = builder;
            return builder;
        }
