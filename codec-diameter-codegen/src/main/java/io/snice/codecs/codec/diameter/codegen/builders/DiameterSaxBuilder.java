package io.snice.codecs.codec.diameter.codegen.builders;

import io.snice.codecs.codec.diameter.codegen.CodeGenParseException;
import io.snice.codecs.codec.diameter.codegen.DiameterCollector;
import io.snice.codecs.codec.diameter.codegen.Typedef;
import io.snice.codecs.codec.diameter.codegen.primitives.ApplicationPrimitive;
import io.snice.codecs.codec.diameter.codegen.primitives.AvpPrimitive;
import io.snice.codecs.codec.diameter.codegen.primitives.DiameterPrimitive;
import io.snice.codecs.codec.diameter.codegen.primitives.EnumPrimitive;
import io.snice.codecs.codec.diameter.codegen.primitives.GavpPrimitive;
import io.snice.codecs.codec.diameter.codegen.primitives.GroupedPrimitive;
import io.snice.codecs.codec.diameter.codegen.primitives.TypePrimitive;
...
public interface DiameterSaxBuilder<T extends DiameterPrimitive> {
    ...
    abstract class BaseBuilder<T extends DiameterPrimitive> implements DiameterSaxBuilder<T> {
        ...
        protected static List<GavpPrimitive> getGavps(final Map<String, List<DiameterPrimitive>> map) {
        ...
        protected static List<TypePrimitive> getTypes(final Map<String, List<DiameterPrimitive>> map) {
        ...
        protected static List<GroupedPrimitive> getGroupeds(final Map<String, List<DiameterPrimitive>> map) {
        ...
        protected static List<EnumPrimitive> getEnums(final Map<String, List<DiameterPrimitive>> map) {
            try {
